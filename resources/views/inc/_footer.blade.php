        ...
        <div class="container pt-4">
            <div class="row">
                <div class="col-lg-4 mb-5 mb-lg-0">
                    <!-- Theme's logo -->
                    <a href="index.html">
                        <img alt="Image placeholder" src="{{ asset('img/brand/light.svg') }}" id="footer-logo">
                    </a>
                    <!-- Webpixels' mission -->
                ...
                <div class="col-md-6">
                    <div class="copyright text-sm font-weight-bold text-center text-md-left">
                        ...
                        @php
                            echo date('Y')
                        @endphp
                        <a href="#" class="font-weight-bold" target="_blank">{{ env('APP_DEVELOPER') }}</a>. All rights reserved
                    </div>
                </div>
                <div class="col-md-6">
